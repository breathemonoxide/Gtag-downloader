namespace GorillaTag_Downloader
{
    partial class Main
    {
        ...
        private void InitializeComponent()
        {
            ...
            button1.Font = new Font("Franklin Gothic Medium", 26.25F, FontStyle.Regular, GraphicsUnit.Point, 0);
            button1.ForeColor = Color.AliceBlue;
            button1.Location = new Point(206, 12);
            button1.Name = "button1";
            button1.Size = new Size(271, 161);
            button1.TabIndex = 1;
            button1.Text = "feb-aug 2021";
            ...
            button8.Font = new Font("Franklin Gothic Medium", 26.25F, FontStyle.Regular, GraphicsUnit.Point, 0);
            button8.ForeColor = Color.AliceBlue;
            button8.Location = new Point(500, 513);
            button8.Name = "button8";
            button8.Size = new Size(271, 161);
            button8.TabIndex = 8;
            button8.Text = "jul-dec 2024";
            button8.UseVisualStyleBackColor = true;
            // 
            // label3
            // 
            label3.AutoSize = true;
            label3.Location = new Point(712, 725);
            label3.Name = "label3";
